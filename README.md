...
Databricks knowledge and course resources.

## Fundamentals

- [Advanced Big Data Management with Databricks and Delta Lake](content/advanced_big_data_management_with_databricks_and_delta_lake.md)

## Resources

1. [Databricks Bootcamps](https://www.youtube.com/watch?v=qndzs1l07sw)
2. [Sign up for Databricks Free Edition](https://docs.databricks.com/aws/en/getting-started/free-edition)
3. [Sign up Databricks](https://drive.google.com/file/d/1wwWF8Xki7NFTyRszhkUDHpzbbO0Xj1Bt/view)
